...
const Layout = ({ children }) => {
  ...
  return (
    <div>
      ...
      <Script id="googlefc-script" nonce="xfSPYvIvCASQi3buWSF2eg">{`(function() {function signalGooglefcPresent() {if (!window.frames['googlefcPresent']) {if (document.body) {const iframe = document.createElement('iframe'); iframe.style = 'width: 0; height: 0; border: none; z-index: -1000; left: -1000px; top: -1000px;'; iframe.style.display = 'none'; iframe.name = 'googlefcPresent'; document.body.appendChild(iframe);} else {setTimeout(signalGooglefcPresent, 0);}}}signalGooglefcPresent();})()`}</Script>

      {/* // Code from AdSense (Ad Blocking Recovery Code - Error Protection Message) */}
      <Script id="googlefc-script-error-protection">
        {`
