...
const PostWidget = ({ categories, slug }) => {
    ...
    return (
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-xl hover:shadow-indigo-500/40 p-8 mb-8 mt-5 transition duration-700 ease-in-out transform hover:-translate-y-1 hover:scale-100 hover:shadow-2xl hover:z-10'>
