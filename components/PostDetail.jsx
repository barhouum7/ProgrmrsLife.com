            ...
            <Tooltip content="Listen to this article" placement="top" style="dark" className="transition duration-700 ease-in-out">
                ...
                >
                    <div className="relative">
                        ...
                        <div className='w-4 h-4 rounded-full align-middle absolute top-0 hover:bg-green-400 hover:bg-opacity-50 hover:animate-ping bg-green-400 dark:hover:bg-green-400 bg-opacity-50 animate-ping-slow cursor-pointer'></div>
                    </div>
                                                        ...
                                                        showPopupPage && (
                                                            <>
                                                                <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex justify-center items-center">
                                                                    <div className="popup-page relative w-full max-w-3xl h-full max-h-[95vh] p-4 text-sm shadow-2xl z-[101] flex flex-col justify-center items-center bg-white dark:bg-gray-800 rounded-lg transition duration-500 ease-in-out transform hover:shadow-indigo-500/40 hover:shadow-2xl">
                                                                        <div className="popup-page__content__header text-gray-900 dark:text-white w-full flex flex-wrap justify-center items-center text-center gap-4 mb-2">
                                                                            <p className='text-xs max-w-lg'>If you appreciate my work, maybe you could show your support by buying me a cup of coffee/tea ☕️🤗</p>
                                                                        ...
                                                                        <div className="popup-page__content__body text-xs text-gray-900 dark:text-white px-8 sm:p-4 overflow-y-auto bg-gray-200 dark:bg-gray-900">
                                                                            {children}
                                                                        </div>
