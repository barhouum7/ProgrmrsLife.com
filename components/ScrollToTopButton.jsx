...
const ScrollToTopButton = () => {
  ...
  return (
    <>
      {showScroll && (
          <button className="fixed bottom-20 right-10 w-12 h-12 rounded-full border-none bg-gray-800 hover:bg-gray-900 cursor-pointer z-20 transform hover:scale-110 hover:shadow-2xl hover:z-10 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-opacity-50 active:bg-gray-700 transition duration-300 ease-in-out" onClick={scrollToTop}>
