...
const PostCard = React.memo(({ post }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl hover:shadow-indigo-500/40 p-4 lg:p-8 pb-12 mb-8 hover:-translate-y-1 hover:scale-100 hover:shadow-2xl hover:z-10">
            <div className="w-full h-full mb-6 rounded-t-lg">
                <div className='h-full w-full'>
                    <Link href={`/post/${post.slug}`}>
                        <Image 
                            ...
                            alt={post.title}
                            className="shadow-2xl rounded-t-lg lg:rounded-lg cursor-pointer hover:opacity-80 transition duration-700 ease-in-out transform hover:-translate-y-2 hover:scale-115 hover:shadow-3xl hover:z-60"
                            loading="lazy"
                            layout='responsive'
                            width={800}
                            height={600}
                ...
                <div className='flex flex-col justify-center items-center mt-4'>
                    ...
                    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
                        ...
                        <div className="flex items-center justify-center gap-x-4 w-full lg:w-auto font-medium text-gray-700 dark:text-gray-200">
                            <div>
