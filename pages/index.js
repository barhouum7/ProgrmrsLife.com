              ...
              totalPages > 1 && (
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-sm text-gray-200 dark:text-gray-400">
                        Showing <span class="font-extrabold text-white dark:text-white">1</span> to <span class="font-extrabold text-white dark:text-white">{currentPosts.length}</span> of <span class="font-extrabold text-white dark:text-white">{posts.length}</span> Entries
                    </span>
